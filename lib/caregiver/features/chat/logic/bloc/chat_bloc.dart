...
class CaregiverChatBloc extends Bloc<CaregiverChatEvent, ChatState> {
  CaregiverChatRepo repoImpl;
  List<MessageModel> messages = [];
  List<Chat> chats = [];
  TextEditingController messageController = TextEditingController();
  CaregiverChatBloc({required this.repoImpl}) : super(ChatInitial()) {
    on<CaregiverChatEvent>((event, emit) async {
      ...
      if (event is CreateNewChatEvent) {
